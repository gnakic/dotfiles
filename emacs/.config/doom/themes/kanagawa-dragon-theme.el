;;; themes/kanagawa-dragon-theme.el -*- lexical-binding: t; -*-
...
(kanagawa-themes--define-variant-colors
  ...
  `((fg ,fuji-white)
    ...
    (selected-line-number ,surimi-orange)))
...
;;;;;;; line numbers
      ...
      (line-number-current-line (:foreground ,selected-line-number :background ,bg-gutter))
;;;;;;; ansi-colors
...
;;;;;;; mode-line
      (mode-line (:foreground ,fg-dim :background ,bg-m1))
      (mode-line-inactive (:foreground ,nontext :background ,bg-m1))
;;;;;;; hl-line-mode
